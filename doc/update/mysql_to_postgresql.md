...
NOTE: **Note:**
This guide assumes you have a working GitLab instance with
MySQL and want to migrate to the bundled PostgreSQL database.
...
For Omnibus GitLab packages, first, you'll need to enable the bundled PostgreSQL
database with up-to-date schema:
