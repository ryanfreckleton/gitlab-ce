...
module Gitlab
  module GitalyClient
    class OperationService
      ...
      def user_dry_merge_to_ref(user, source_sha, branch, target_ref, message)
        request = Gitaly::UserDryMergeToRefRequest.new(
          repository: @gitaly_repo,
        ...
        response = GitalyClient.call(@repository.storage, :operation_service, :user_dry_merge_to_ref, request)
